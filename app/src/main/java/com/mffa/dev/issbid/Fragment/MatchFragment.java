...
public class MatchFragment extends Fragment {
    ...
    private CollectionReference table_match,table_tim;
    ...
    String tglSekarang;
    private EditText skor,nmPemain,menitGoals;
    private Button btnupdateSkor;
    private Query qr;
    private String todayAsString,todaywithdate;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.rc_match);
        ...
        DateFormat dateFormatnoday = new SimpleDateFormat("EEE, MM/yyyy");

        todayAsString = dateFormat.format(today);
        todaywithdate = dateFormatnoday.format(today);

        qr = table_match.whereEqualTo("tanggal",todaywithdate)
                .whereEqualTo("remindTime", tglSekarang);
